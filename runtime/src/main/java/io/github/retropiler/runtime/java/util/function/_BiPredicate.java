...
public interface _BiPredicate<T, U> {
     ...
     */
    default _BiPredicate<T, U> and(_BiPredicate<? super T, ? super U> other) {
     ...
     * predicate
     */
    default _BiPredicate<T, U> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default _BiPredicate<T, U> or(_BiPredicate<? super T, ? super U> other) {
        _Objects.requireNonNull(other);
        return (T t, U u) -> test(t, u) || other.test(t, u);
    }
}
