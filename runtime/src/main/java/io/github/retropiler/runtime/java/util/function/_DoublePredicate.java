 ...
 */
@FunctionalInterface
public interface _DoublePredicate {
     ...
     */
    default _DoublePredicate and(_DoublePredicate other) {
     ...
     * predicate
     */
    default _DoublePredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default _DoublePredicate or(_DoublePredicate other) {
        _Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
}
